class PokemonResponse {
  ...
  factory PokemonResponse.fromJson(Map<String, dynamic> json) => PokemonResponse(
        abilities: List<AbilityResponse>.from(json["abilities"].map((x) => AbilityResponse.fromJson(x))),
...
class AbilityResponse {
  ...
  factory AbilityResponse.fromJson(Map<String, dynamic> json) => AbilityResponse(
